...
{
	const int particleSize = 3 * 4; // Size of float_3 object as number of bytes.
    ...
    output.color = lerp( float4(1,0.1,0.1,1), float4(input.pos.x, input.pos.y, input.pos.z, 0.0), output.pos.z);
