...
//D3D10_SHADER_ENABLE_STRICTNESS
    ...
    V_RETURN( pd3dDevice->CreateInputLayout( layout, sizeof(*RtlpNumberOf(layout)), pVSBlob->GetBufferPointer(), pVSBlob->GetBufferSize(), &m_pInputLayout11 ) );
...
// Used to draw static text 
void DrawText11DXUTCaptions( ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3d11DeviceContext,
                 LPCWSTR strText, RECT rcScreen, D3DXCOLOR vFontColor,
                 float fBBWidth, float fBBHeight, bool bCenter )
{
    float fCharTexSizeX = 0.010526315f;
	// Control the height and width of char
    float fGlyphSizeX = 30.0f / fBBWidth;
    float fGlyphSizeY = 84.0f / fBBHeight;
